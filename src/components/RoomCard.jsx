  ...
  return (
   ...
   transition={{duration:2,ease:"easeInOut"}}>
     ...
     <div className='rounded-xl shadow-xl overflow-hidden transition-transform duration-200 ease-out max-w-80 bg-white px-3 md:px-5'>
        ...
        <h1 className='mt-3 px-4 pt-3 mb-1 text-lg font-semibold text-gray-800'>{room.roomType}           
        </h1>
     <div className='flex items-center gap-4 justify-between'>
        ...
        }} className='bg-blue-600 text-white rounded-md px-4 py-1 mb-3 cursor-pointer'
        >See Details</button>
