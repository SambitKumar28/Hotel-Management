...
const Testimonials = () => {
  return (
    <div className="py-12 flex flex-wrap items-center justify-center gap-6 pt-14">
            ...
            <motion.div animate={{y:[0,-30,0]}} 
            transition={{repeat:Infinity,ease:"easeInOut", duration:2 }}  className="text-sm w-80 border border-gray-200 pb-6 rounded-lg bg-white shadow-[0px_4px_15px_0px] shadow-black/5">
                <div className="flex flex-col items-center px-5 py-4 relative">
            ...
            <motion.div animate={{y:[0,-30,0]}} 
            transition={{repeat:Infinity,ease:"easeInOut", duration:3 }}  className="text-sm w-80 border border-gray-200 pb-6 rounded-lg bg-white shadow-[0px_4px_15px_0px] shadow-black/5">
                <div className="flex flex-col items-center px-5 py-4 relative">
