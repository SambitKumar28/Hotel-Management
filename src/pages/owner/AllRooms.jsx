              ...
              <thead className='bg-gradient-to-r from-blue-600 to-indigo-600 text-white'>
               ...
               <tbody className='divide-y divide-gray-100'>
                {roomData.map((room,index)=>(
                  <tr key={room._id} className={`hover:bg-blue-50 transition-all duration-200 ${index % 2===0 ? "bg-white" : "bg-gray-50"}`}>
                    <td className='px-6 py-6'>
                      <div className='flex items-center space-x-4'>
                        ...
                        <div>
                          <h3 className='text-lg font-semibold text-gray-800 hover:text-blue-600 transition-colors'>{room.hotel.name}</h3>
                        </div>
                      </div>
                    </td>
                    <td className='px-6 py-6'>
                     ...
                     <td className='px-6 py-6'>
                      <div className='flex items-start space-x-2'>
                        <span className='text-gray-600 text-sm leading-relaxed'>{room.hotel.address}</span>
                      </div>
                    </td>
                     <td className='px-6 py-6'>
                      <div className='flex items-start space-x-2'>
